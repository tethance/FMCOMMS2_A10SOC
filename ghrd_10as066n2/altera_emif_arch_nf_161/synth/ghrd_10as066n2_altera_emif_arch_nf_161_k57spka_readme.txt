...
---------------------
  ...
  9. Sharing RZQ pin between interfaces
 10. Global reset interface
 11. PLL reference clock interface
 12. OCT interface
 13. Interface between FPGA and external memory
 14. Conduit between Hard Processor Subsystem and memory interface
 15. Instantiating IP in a simulation project
 16. Full-calibration versus skip-calibration simulation
 17. IP Settings
 18. Configuring the Traffic Generator
...
------------------------
   ...
   This is the readme file for the Altera External Memory Interface (EMIF) IP v16.1.
...
--------------------
   ...
   SYS_INFO_UNIQUE_ID                                : ghrd_10as066n2_emif_a10_hps_0
   ...
   PLL_MAPPED_SYS_INFO_DEVICE                        : 10AS066N3F40E2SG
   PLL_MAPPED_SYS_INFO_DEVICE_SPEEDGRADE             : 2
   PLL_MAPPED_REFERENCE_CLOCK_FREQUENCY              : 133.333
   PLL_MAPPED_VCO_FREQUENCY                          : 1066.664 MHz
   PLL_MAPPED_EXTERNAL_PLL_MODE                      : true
   PLL_ADD_EXTRA_CLKS                                : 0
   PLL_COMPENSATION_MODE                             : emif
   PLL_USER_NUM_OF_EXTRA_CLKS                        : 0
   PLL_EXTRA_CLK_DESIRED_FREQ_MHZ_GUI_0              : 533.3335
   PLL_EXTRA_CLK_ACTUAL_FREQ_MHZ_GUI_0               : 533.3335
   PLL_EXTRA_CLK_ACTUAL_FREQ_MHZ_0                   : 533.332
   ...
   PLL_EXTRA_CLK_ACTUAL_PHASE_PS_0                   : 117.18779296948243
   ...
   PLL_EXTRA_CLK_DESIRED_FREQ_MHZ_GUI_1              : 533.3335
   PLL_EXTRA_CLK_ACTUAL_FREQ_MHZ_GUI_1               : 533.3335
   PLL_EXTRA_CLK_ACTUAL_FREQ_MHZ_1                   : 533.332
   ...
   PLL_EXTRA_CLK_ACTUAL_PHASE_PS_1                   : 117.18779296948243
   ...
   PLL_EXTRA_CLK_DESIRED_FREQ_MHZ_GUI_2              : 533.3335
   PLL_EXTRA_CLK_ACTUAL_FREQ_MHZ_GUI_2               : 533.3335
   PLL_EXTRA_CLK_ACTUAL_FREQ_MHZ_2                   : 533.332
   ...
   PLL_EXTRA_CLK_ACTUAL_PHASE_PS_2                   : 117.18779296948243
   ...
   PLL_EXTRA_CLK_DESIRED_FREQ_MHZ_GUI_3              : 152.381
   PLL_EXTRA_CLK_ACTUAL_FREQ_MHZ_GUI_3               : 152.381
   PLL_EXTRA_CLK_ACTUAL_FREQ_MHZ_3                   : 152.38057142857141
   ...
   PLL_EXTRA_CLK_DESIRED_FREQ_MHZ_GUI_4              : 152.381
   PLL_EXTRA_CLK_ACTUAL_FREQ_MHZ_GUI_4               : 152.381
   PLL_EXTRA_CLK_ACTUAL_FREQ_MHZ_4                   : 152.38057142857141
