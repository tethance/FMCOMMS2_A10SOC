...
source "$script_dir/ghrd_10as066n2_altera_emif_arch_nf_161_guvuorq_report_timing_core.tcl"


if [ info exists ddr_db ] {
   unset ddr_db
}
ghrd_10as066n2_altera_emif_arch_nf_161_guvuorq_initialize_ddr_db ddr_db var
...
foreach inst $instances {
   ...
   if {[llength $instances] <= 1} {
      set fbasename "${::GLOBAL_ghrd_10as066n2_altera_emif_arch_nf_161_guvuorq_corename}"
   } else {
      set fbasename "${::GLOBAL_ghrd_10as066n2_altera_emif_arch_nf_161_guvuorq_corename}_${inst_id}"
   }
   ...
   ghrd_10as066n2_altera_emif_arch_nf_161_guvuorq_perform_read_capture_analysis $opcname $inst pins var summary
   
   #######################################
   # Write Analysis

   ghrd_10as066n2_altera_emif_arch_nf_161_guvuorq_perform_write_launch_analysis $opcname $inst pins var summary

   #######################################
   # Address/command Analyses

   ghrd_10as066n2_altera_emif_arch_nf_161_guvuorq_perform_ac_analysis  $opcname $inst pins var summary

   #######################################
   # DQS Gating Analysis

   ghrd_10as066n2_altera_emif_arch_nf_161_guvuorq_perform_dqs_gating_analysis   $opcname $inst pins var summary

   #######################################
   # Write Levelling Analysis 
   
   ghrd_10as066n2_altera_emif_arch_nf_161_guvuorq_perform_write_levelling_analysis $opcname $inst pins var summary

   #######################################
   # PHY Analyses
   
   ghrd_10as066n2_altera_emif_arch_nf_161_guvuorq_perform_core_analysis $opcname $inst pins var summary

   #######################################
   # Print out the Summary Panel for this instance   

   set summary [lsort -command ghrd_10as066n2_altera_emif_arch_nf_161_guvuorq_sort_proc $summary]
   ...
   puts $f "Core: ${::GLOBAL_ghrd_10as066n2_altera_emif_arch_nf_161_guvuorq_corename} - Instance: $inst"
   puts $f "Path, Setup Margin, Hold Margin"

   
   post_message -type info "Core: ${::GLOBAL_ghrd_10as066n2_altera_emif_arch_nf_161_guvuorq_corename} - Instance: $inst"
   ...
   foreach summary_line $summary {
      ...
      if {$su != "--"} {
         set su [ ghrd_10as066n2_altera_emif_arch_nf_161_guvuorq_round_3dp $su]
      }
      if {$hold != "--"} {
         set hold [ ghrd_10as066n2_altera_emif_arch_nf_161_guvuorq_round_3dp $hold]
      }
