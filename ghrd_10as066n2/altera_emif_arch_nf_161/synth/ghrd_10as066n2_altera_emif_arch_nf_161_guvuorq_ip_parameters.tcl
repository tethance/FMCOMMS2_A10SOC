...
set ::GLOBAL_ghrd_10as066n2_altera_emif_arch_nf_161_guvuorq_corename ghrd_10as066n2_altera_emif_arch_nf_161_guvuorq

set var(PROTOCOL)                                                DDR4
set var(NUM_RANKS)                                               1
set var(SLEW_RATE_DRAM)                                          4.0
set var(SLEW_RATE_DRAM_CLOCK)                                    8.0
set var(VIN_Ms)                                                  0.13600000000000001
set var(VIN_Mh)                                                  0.068000000000000005
...
set var(tDS)                                                     0.046874985351567089
set var(tDH)                                                     0.046874985351567089
set var(tIS)                                                     0.059999999999999998
set var(tIH)                                                     0.095000000000000001
set var(tDQSCK)                                                  0.16500000000000001
set var(tDQSS)                                                   0.27
set var(tWLS)                                                    0.108
set var(tWLH)                                                    0.108
set var(tDSS)                                                    0.18
