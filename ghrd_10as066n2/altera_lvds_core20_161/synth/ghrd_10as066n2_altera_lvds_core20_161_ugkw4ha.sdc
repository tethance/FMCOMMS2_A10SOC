...
set libname ghrd_10as066n2_altera_lvds_core20_161_ugkw4ha 
...
set OC_P2C_SU 0.0
set OC_P2C_H  0.0
set use_external_pll 1
set j_factor 4 
set ref_clock_period_ns 4.0 
set slow_clock_period_ns 8.0 
set fast_clock_period_ns 2.0 
set sclk_multiply_by 4 
set sclk_divide_by 8 
set sclk_phase 0.0 
set fclk_multiply_by 4 
set fclk_divide_by 2 
set fclk_phase 180 
set loaden_multiply_by 4 
set loaden_divide_by 8 
set loaden_phase 270.0 
set loaden_duty 25.0 
set tx_outclock_fclk_multiply_by 4 
set tx_outclock_fclk_divide_by 8 
set tx_outclock_fclk_phase 0 
set tx_outclock_loaden_multiply_by 4 
set tx_outclock_loaden_divide_by 1 
set tx_outclock_loaden_phase 0.0 
set tx_outclock_loaden_duty 25.0 
...
foreach lvds_instance_name $lvds_instance_name_list {  
   ...
   if {[catch {set pll_out_pin [get_node_info -name [altera_iosubsystem_get_src_pll_out_pin ${lvds_core_instance_name}|dprio_clk_gen.dprio_div_counter[1]]]}]} { set pll_out_pin "" } 
   ...
   if {$fit_flow == 1} { 
      set_max_delay -from ${lvds_core_instance_name}|channels[*].dpa_fifo.serdes_dpa_inst~dpa_reg -to [get_fanouts ${lvds_core_instance_name}|channels[*].dpa_fifo.serdes_dpa_inst|dpalock] [expr 2*$slow_clock_period_ns] 
   } else { 
      set_false_path -from ${lvds_core_instance_name}|channels[*].dpa_fifo.serdes_dpa_inst~dpa_reg -to [get_fanouts ${lvds_core_instance_name}|channels[*].dpa_fifo.serdes_dpa_inst|dpalock] 
   } 
   ...
   set through_pin_collection [get_pins -nowarn ${lvds_core_instance_name}|channels[*].dpa_fifo.serdes_dpa_inst|fiforeset] 
   if {[get_collection_size $through_pin_collection] > 0} { 
      if {$fit_flow == 1} { 
         set_max_delay -through [get_pins -nowarn ${lvds_core_instance_name}|channels[*].dpa_fifo.serdes_dpa_inst|fiforeset] [expr 2*$slow_clock_period_ns] 
      } else { 
         set_false_path -through [get_pins -nowarn ${lvds_core_instance_name}|channels[*].dpa_fifo.serdes_dpa_inst|fiforeset] 
      } 
   } 
   ...
   set through_pin_collection [get_pins -nowarn ${lvds_core_instance_name}|channels[*].dpa_fifo.serdes_dpa_inst|dpareset] 
   if {[get_collection_size $through_pin_collection] > 0} { 
      if {$fit_flow == 1} { 
         set_max_delay -through [get_pins -nowarn ${lvds_core_instance_name}|channels[*].dpa_fifo.serdes_dpa_inst|dpareset] [expr 2*$slow_clock_period_ns] 
      } else { 
         set_false_path -through [get_pins -nowarn ${lvds_core_instance_name}|channels[*].dpa_fifo.serdes_dpa_inst|dpareset] 
      } 
   } 
   ...
   set to_pin_collection [get_keepers -nowarn ${lvds_core_instance_name}|channels[*].dpa_fifo.rx_bitslip|bitslip_reset_synchronizer|sync_reg[0]] 
   if {[get_collection_size $to_pin_collection] > 0} { 
      if {$fit_flow == 1} { 
         set_max_delay -to [get_keepers -nowarn ${lvds_core_instance_name}|channels[*].dpa_fifo.rx_bitslip|bitslip_reset_synchronizer|sync_reg[0]] [expr 2*$slow_clock_period_ns] 
      } else { 
         set_false_path -to [get_keepers -nowarn ${lvds_core_instance_name}|channels[*].dpa_fifo.rx_bitslip|bitslip_reset_synchronizer|sync_reg[0]] 
      } 
   } 
   ...
   set to_pin_collection [get_keepers -nowarn ${lvds_core_instance_name}|channels[*].dpa_fifo.rx_bitslip|bitslip_ctrl_synchronizer|sync_reg[0]] 
   if {[get_collection_size $to_pin_collection] > 0} { 
      if {$fit_flow == 1} { 
         set_max_delay -to [get_keepers -nowarn ${lvds_core_instance_name}|channels[*].dpa_fifo.rx_bitslip|bitslip_ctrl_synchronizer|sync_reg[0]] [expr 2*$slow_clock_period_ns] 
      } else { 
         set_false_path -to [get_keepers -nowarn ${lvds_core_instance_name}|channels[*].dpa_fifo.rx_bitslip|bitslip_ctrl_synchronizer|sync_reg[0]] 
      } 
   } 
