// ghrd_10as066n2_altera_lvds_161_l5lsykq.v
...
`timescale 1 ps / 1 ps
module ghrd_10as066n2_altera_lvds_161_l5lsykq (
		input  wire [0:0] rx_in,          //          rx_in.export
		output wire [3:0] rx_out,         //         rx_out.export
	...
	ghrd_10as066n2_altera_lvds_core20_161_ugkw4ha #(
		.NUM_CHANNELS                       (1),
		.J_FACTOR                           (4),
		.RX_BITSLIP_ROLLOVER                (4),
		.TX_REGISTER_CLOCK                  ("tx_coreclock"),
		.TX_OUTCLOCK_NON_STD_PHASE_SHIFT    ("false"),
		.SERDES_DPA_MODE                    ("dpa_mode_fifo"),
		...
		.LOOPBACK_MODE                      (0),
		.SILICON_REV                        ("20nm5"),
		.pll_input_clock_frequency          ("250.0 MHz"),
		.pll_vco_clock_frequency            ("999.9999999999999 MHz"),
		.m_cnt_hi_div                       (2),
		.m_cnt_lo_div                       (2),
		.n_cnt_hi_div                       (256),
		.n_cnt_lo_div                       (256),
		...
		.pll_output_clock_frequency_0       ("500.0 MHz"),
		.pll_output_phase_shift_0           ("1000 ps"),
		.pll_output_duty_cycle_0            (50),
		.pll_output_clock_frequency_1       ("125.0 MHz"),
		.pll_output_phase_shift_1           ("6000 ps"),
		.pll_output_duty_cycle_1            (25),
		...
		.ext_vcoph              (ext_vcoph),      //      ext_vcoph_conduit_end.export
		.ext_pll_locked         (ext_pll_locked), // ext_pll_locked_conduit_end.export
		.rx_dpa_locked          (rx_dpa_locked),  //  rx_dpa_locked_conduit_end.export
		.tx_in                  (4'b0000),        //                (terminated)
		.tx_out                 (),               //                (terminated)
