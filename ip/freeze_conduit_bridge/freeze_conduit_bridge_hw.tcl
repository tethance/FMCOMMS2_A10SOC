...
# add_parameter CONDUIT_PORT_INFO string ""
# set_parameter_property CONDUIT_PORT_INFO system_info FREEZECONDUIT_INFO
# set_parameter_property CONDUIT_PORT_INFO system_info_arg "*"
# set_parameter_property CONDUIT_PORT_INFO AFFECTS_ELABORATION true
# set_parameter_property CONDUIT_PORT_INFO visible false
...
add_interface freeze_conduit_in conduit end
set_interface_property freeze_conduit_in associatedClock ""
set_interface_property freeze_conduit_in associatedReset ""
set_interface_property freeze_conduit_in ENABLED true
set_interface_property freeze_conduit_in EXPORT_OF ""
set_interface_property freeze_conduit_in PORT_NAME_MAP ""
set_interface_property freeze_conduit_in CMSIS_SVD_VARIABLES ""
set_interface_property freeze_conduit_in SVD_ADDRESS_GROUP ""

add_interface freeze_conduit_out conduit end
set_interface_property freeze_conduit_out associatedClock ""
set_interface_property freeze_conduit_out associatedReset ""
set_interface_property freeze_conduit_out ENABLED true
set_interface_property freeze_conduit_out EXPORT_OF ""
set_interface_property freeze_conduit_out PORT_NAME_MAP ""
set_interface_property freeze_conduit_out CMSIS_SVD_VARIABLES ""
set_interface_property freeze_conduit_out SVD_ADDRESS_GROUP ""

add_interface_port freeze_conduit_in  freeze  freeze  Input  1
add_interface_port freeze_conduit_out freeze_ack  freeze_ack Output 1
add_interface_port freeze_conduit_out illegal_request illegal_request  Output 1
...
# set_fileset_property SYNTH TOP_LEVEL ${OUTPUT_NAME}
# set_fileset_property SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
# set_fileset_property SYNTH ENABLE_FILE_OVERWRITE_MODE true
# +-----------------------------------
# | Generation callback
# +-----------------------------------
proc generate {OUTPUT_NAME} {
    ...
    # add_fileset_file freeze_conduit_bridge.sv SYSTEM_VERILOG TEXT $result TOP_LEVEL_FILE
